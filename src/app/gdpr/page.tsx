          ...
          <div className="bg-card rounded-lg shadow-sm p-8 md:p-12 border border-border">
            ...
            <div className="prose prose-lg max-w-none">
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">1. Introducción</h2>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">2. Base Legal para el Procesamiento</h2>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">3. Sus Derechos bajo el GDPR</h2>
                
                <h3 className="text-xl font-semibold text-text-primary mb-3">3.1. Derecho de Acceso</h3>
                <p className="text-text-secondary mb-4">
                  Tiene derecho a acceder a sus datos personales y recibir información sobre cómo los procesamos.
                </p>

                <h3 className="text-xl font-semibold text-text-primary mb-3">3.2. Derecho de Rectificación</h3>
                <p className="text-text-secondary mb-4">
                  Puede solicitar la corrección de datos inexactos o incompletos.
                </p>

                <h3 className="text-xl font-semibold text-text-primary mb-3">3.3. Derecho de Supresión ("Derecho al Olvido")</h3>
                <p className="text-text-secondary mb-4">
                  Puede solicitar la eliminación de sus datos personales cuando ya no sean necesarios o cuando retire su consentimiento.
                </p>

                <h3 className="text-xl font-semibold text-text-primary mb-3">3.4. Derecho a la Limitación del Procesamiento</h3>
                <p className="text-text-secondary mb-4">
                  Puede solicitar que limitemos el procesamiento de sus datos en ciertas circunstancias.
                </p>

                <h3 className="text-xl font-semibold text-text-primary mb-3">3.5. Derecho a la Portabilidad de Datos</h3>
                <p className="text-text-secondary mb-4">
                  Puede recibir sus datos personales en un formato estructurado y comúnmente utilizado, y transmitirlos a otro controlador.
                </p>

                <h3 className="text-xl font-semibold text-text-primary mb-3">3.6. Derecho de Oposición</h3>
                <p className="text-text-secondary mb-4">
                  Puede oponerse al procesamiento de sus datos personales cuando se base en interés legítimo o marketing directo.
                </p>

                <h3 className="text-xl font-semibold text-text-primary mb-3">3.7. Derecho a Retirar el Consentimiento</h3>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">4. Ejercer sus Derechos</h2>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">5. Transferencias Internacionales</h2>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">6. Medidas de Seguridad</h2>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">8. Notificación de Violaciones de Datos</h2>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">9. Autoridad Supervisora</h2>
                <p className="text-text-secondary mb-4">
                ...
                <p className="text-text-secondary mb-4">
                  ...
                  <a href="https://www.aepd.es" target="_blank" rel="noopener noreferrer" className="text-text-primary hover:text-text-secondary underline">www.aepd.es</a>
                </p>
              </section>
