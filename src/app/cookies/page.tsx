...
export default function CookiePolicyPage() {
  return (
    <div className="min-h-screen flex flex-col">
      <Header />
      <main className="flex-grow bg-app py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-card rounded-lg shadow-sm p-8 md:p-12 border border-border">
            ...
            <div className="prose prose-lg max-w-none">
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">1. ¿Qué son las Cookies?</h2>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">2. Cómo Utilizamos las Cookies</h2>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">3. Tipos de Cookies que Utilizamos</h2>
                
                <h3 className="text-xl font-semibold text-text-primary mb-3">3.1. Cookies Esenciales</h3>
                <p className="text-text-secondary mb-4">
                ...
                <h3 className="text-xl font-semibold text-text-primary mb-3">3.2. Cookies de Funcionalidad</h3>
                <p className="text-text-secondary mb-4">
                ...
                <h3 className="text-xl font-semibold text-text-primary mb-3">3.3. Cookies Analíticas</h3>
                <p className="text-text-secondary mb-4">
                ...
                <h3 className="text-xl font-semibold text-text-primary mb-3">3.4. Cookies de Marketing</h3>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">4. Cookies de Terceros</h2>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">5. Gestión de Cookies</h2>
                <p className="text-text-secondary mb-4">
                ...
                <ul className="list-disc list-inside text-text-secondary mb-4 space-y-2">
                  <li><a href="https://support.google.com/chrome/answer/95647" target="_blank" rel="noopener noreferrer" className="text-text-primary hover:text-text-secondary underline">Google Chrome</a></li>
                  <li><a href="https://support.mozilla.org/es/kb/habilitar-y-deshabilitar-cookies-sitios-web-rastrear-preferencias" target="_blank" rel="noopener noreferrer" className="text-text-primary hover:text-text-secondary underline">Mozilla Firefox</a></li>
                  <li><a href="https://support.apple.com/es-es/guide/safari/sfri11471/mac" target="_blank" rel="noopener noreferrer" className="text-text-primary hover:text-text-secondary underline">Safari</a></li>
                  <li><a href="https://support.microsoft.com/es-es/microsoft-edge/eliminar-las-cookies-en-microsoft-edge-63947406-40ac-c3b8-57b9-2d9461b58be0" target="_blank" rel="noopener noreferrer" className="text-text-primary hover:text-text-secondary underline">Microsoft Edge</a></li>
                </ul>
              </section>

              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">6. Consentimiento</h2>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">7. Cambios a esta Política</h2>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                ...
                <p className="text-text-secondary">
                  Email: <a href="mailto:soporte@avocatapp.com" className="text-text-primary hover:text-text-secondary underline">soporte@avocatapp.com</a>
                </p>
              </section>
            </div>
          </div>
