        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-card rounded-lg shadow-sm p-8 md:p-12 border border-border">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">2. Descripción del Servicio</h2>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">3. Cuentas de Usuario</h2>
                <h3 className="text-xl font-semibold text-text-primary mb-3">3.1. Registro</h3>
                <p className="text-text-secondary mb-4">
                ...
                <h3 className="text-xl font-semibold text-text-primary mb-3">3.2. Responsabilidades del Usuario</h3>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">4. Uso Aceptable</h2>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">5. Propiedad Intelectual</h2>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">6. Pagos y Facturación</h2>
                <h3 className="text-xl font-semibold text-text-primary mb-3">6.1. Precios</h3>
                <p className="text-text-secondary mb-4">
                ...
                <h3 className="text-xl font-semibold text-text-primary mb-3">6.2. Facturación</h3>
                <p className="text-text-secondary mb-4">
                ...
                <h3 className="text-xl font-semibold text-text-primary mb-3">6.3. Reembolsos</h3>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">7. Limitación de Responsabilidad</h2>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">8. Modificaciones del Servicio</h2>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">9. Terminación</h2>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">10. Ley Aplicable</h2>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">11. Contacto</h2>
                <p className="text-text-secondary mb-4">
