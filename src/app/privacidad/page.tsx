        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-card rounded-lg shadow-sm p-8 md:p-12 border border-border">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">2. Información que Recopilamos</h2>
                <h3 className="text-xl font-semibold text-text-primary mb-3">2.1. Información Personal</h3>
                <p className="text-text-secondary mb-4">
                ...
                <h3 className="text-xl font-semibold text-text-primary mb-3">2.2. Información de Uso</h3>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">3. Cómo Utilizamos su Información</h2>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">4. Compartir Información</h2>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">5. Seguridad de los Datos</h2>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">6. Sus Derechos</h2>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">8. Cambios a esta Política</h2>
                <p className="text-text-secondary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-text-primary mb-4">9. Contacto</h2>
                <p className="text-text-secondary mb-4">
