        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            <div className="bg-card p-4 rounded-lg shadow-sm border border-border">
              ...
              <div className="text-sm text-text-secondary">{t('dashboard.urgentCases.totalUrgent')}</div>
            </div>
            <div className="bg-card p-4 rounded-lg shadow-sm border border-border">
              <div className="text-2xl font-bold text-orange-600">
                {urgentCases.filter(c => c.priority === 'critical').length}
              </div>
              <div className="text-sm text-text-secondary">{t('dashboard.urgentCases.critical')}</div>
            </div>
            <div className="bg-card p-4 rounded-lg shadow-sm border border-border">
              <div className="text-2xl font-bold text-yellow-600">
                {urgentCases.filter(c => c.priority === 'urgent').length}
              </div>
              <div className="text-sm text-text-secondary">{t('dashboard.urgentCases.urgent')}</div>
            </div>
            <div className="bg-card p-4 rounded-lg shadow-sm border border-border">
              <div className="text-2xl font-bold text-blue-600">
                {urgentCases.filter(c => c.priority === 'high').length}
              </div>
              <div className="text-sm text-text-secondary">{t('dashboard.urgentCases.highPriority')}</div>
            </div>
          </div>
          ...
          <div className="bg-card shadow-sm rounded-lg border border-border">
            ...
            {casesLoading ? (
              <div className="p-8 text-center">
                ...
                <p className="mt-4 text-text-secondary">{t('dashboard.urgentCases.loading')}</p>
              </div>
            ) : (
