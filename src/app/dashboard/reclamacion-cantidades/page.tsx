              ...
              <div className="px-4 py-5 sm:p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-sm text-gray-600">
                      Crea una nueva reclamación de cantidades
                    </p>
                  </div>
                </div>
                <div className="mt-4">
                  <Link href="/claims/new" className="btn-primary w-full text-center">
                    Crear
                  </Link>
                </div>
              </div>
              ...
              <div className="px-4 py-5 sm:p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-sm text-gray-600">
                      Gestiona y sigue el estado de tus reclamaciones
                    </p>
                  </div>
                </div>
                <div className="mt-4">
                  <Link href="/claims" className="btn-primary w-full text-center">
                    Ver Todas
                  </Link>
                </div>
              </div>
              ...
              <div className="px-4 py-5 sm:p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-sm text-gray-600">
                      Accede a plantillas para reclamaciones
                    </p>
                  </div>
                </div>
                <div className="mt-4">
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-500">Total Reclamado</p>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-500">Reclamaciones Activas</p>
            ...
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-sm text-gray-600">
                    Crea tu primera reclamación de cantidades
                  </p>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 bg-orange-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                  ...
                  <p className="text-sm text-gray-600">
                    Sigue el progreso y estado de tu reclamación
                  </p>
                </div>
              </div>
            </div>
