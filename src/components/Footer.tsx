...
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: 'Twitter',
      href: 'https://twitter.com/avocat_legaltech',
      icon: (
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/company/avocat-legaltech',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/andreslevano/avocatapp_legaltech_v3',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 pt-8 mb-8">
          <div className="max-w-md">
            ...
            <p className="text-gray-400 mb-4">
              Recibe las últimas actualizaciones sobre nuevas funciones e información sobre tecnología legal.
            </p>
